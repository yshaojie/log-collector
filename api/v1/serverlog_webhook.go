...
//+kubebuilder:webhook:path=/mutate-xy-io-xy-io-v1-serverlog,mutating=true,failurePolicy=fail,sideEffects=None,groups=xy.io.xy.io,resources=serverlogs,verbs=create;update,versions=v1,name=mserverlog.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-xy-io-xy-io-v1-serverlog,mutating=false,failurePolicy=fail,sideEffects=None,groups=xy.io.xy.io,resources=serverlogs,verbs=create;update,versions=v1,name=vserverlog.kb.io,admissionReviewVersions=v1
